...
func deepEqualsSourcepointUnifiedCmp(_ lhs: Any?, _ rhs: Any?) -> Bool {
  ...
  case let (cleanLhsArray, cleanRhsArray) as ([Any?], [Any?]):
    ...
    for (index, element) in cleanLhsArray.enumerated() {
      if !deepEqualsSourcepointUnifiedCmp(element, cleanRhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case let (cleanLhsDictionary, cleanRhsDictionary) as ([AnyHashable: Any?], [AnyHashable: Any?]):
    ...
    for (key, cleanLhsValue) in cleanLhsDictionary {
      ...
      if !deepEqualsSourcepointUnifiedCmp(cleanLhsValue, cleanRhsDictionary[key]!) {
        return false
      }
    }
    return true
...
func deepHashSourcepointUnifiedCmp(value: Any?, hasher: inout Hasher) {
  if let valueList = value as? [AnyHashable] {
     for item in valueList { deepHashSourcepointUnifiedCmp(value: item, hasher: &hasher) }
     return
  }
  ...
  if let valueDict = value as? [AnyHashable: AnyHashable] {
    for key in valueDict.keys { 
      hasher.combine(key)
      deepHashSourcepointUnifiedCmp(value: valueDict[key]!, hasher: &hasher)
    }
    return
  }
...
struct HostAPISPError: Hashable {
  ...
  static func == (lhs: HostAPISPError, rhs: HostAPISPError) -> Bool {
    return deepEqualsSourcepointUnifiedCmp(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashSourcepointUnifiedCmp(value: toList(), hasher: &hasher)
  }
}
