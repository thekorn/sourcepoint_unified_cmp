...
private fun deepEqualsSourcepointUnifiedCmp(a: Any?, b: Any?): Boolean {
  ...
  if (a is Array<*> && b is Array<*>) {
    return a.size == b.size &&
        a.indices.all{ deepEqualsSourcepointUnifiedCmp(a[it], b[it]) }
  }
  ...
  if (a is Map<*, *> && b is Map<*, *>) {
    return a.size == b.size && a.all {
        ...
        deepEqualsSourcepointUnifiedCmp(it.value, b[it.key])
    }
  }
  return a == b
}
...
data class HostAPIConsentAction (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return deepEqualsSourcepointUnifiedCmp(toList(), other.toList())  }
