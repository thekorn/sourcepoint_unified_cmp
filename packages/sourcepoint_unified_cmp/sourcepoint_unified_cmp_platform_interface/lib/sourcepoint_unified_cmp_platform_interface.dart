...
///  this interface will be broken by newly added [SourcepointUnifiedCmpPlatform] methods.
abstract class SourcepointUnifiedCmpPlatform extends PlatformInterface {
  ...
  static SourcepointUnifiedCmpPlatform _instance = MethodChannelSourcepointUnifiedCmp();
  ...
  /// class that extends [SourcepointUnifiedCmpPlatform] when they register themselves.
