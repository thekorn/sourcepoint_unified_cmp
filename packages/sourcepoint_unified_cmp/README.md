...
in the front facing package `sourcepoint_unified_cmp` example. 
...
```sh
cd sourcepoint_unified_cmp/example
fluttium test flows/test_platform_name.yaml
```

[coverage_badge]: sourcepoint_unified_cmp/coverage_badge.svg
